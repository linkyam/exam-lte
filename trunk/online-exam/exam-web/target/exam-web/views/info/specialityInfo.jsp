                        ...
                        <div class="row-fluid">
                            <div class="span3">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select class="span12" id="collegeIdSearch">
                            ...
                            <div class="span3">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select class="span12" id="speYearSearch">
                            ...
                            <div class="span3">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="m-wrap span12" id="speNameSearch">
                                    </div>
                                </div>
                            </div>
                            <div class="span3">
                ...
                <div class="modal-body">
                    <form class="form-horizontal" id="insertForm" action="#">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <div class="input-icon left">
                                    <select class="span8" id="collegeId" name="collegeId">
                                    </select>
                                </div>
                            </div>
                        </div>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <div class="input-icon left">
                                    <select class="span8" id="speyearsId" name="speyearsId">
                                    </select>
                                </div>
                            </div>
                        </div>
